 ...
 */
@Aspect
public class BaseFieldSuffixHandler {

	/**
	 * FieldSuffix base class
	 * @param o data
	...
	@AfterReturning(returning = "data", pointcut = "@annotation(com.again.common.annotation.FieldSuffix)")
	public Object around(JoinPoint joinPoint, Object data) throws Throwable {
		...
		this.setFieldValueForCollection(fieldSuffix, vestIn(data));
		return data;
	}
