...
public final class CommonServiceGrpc {
	...
	private static volatile io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getMethodMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "method",
			requestType = com.again.boot.Request.class, responseType = com.again.boot.Response.class,
			methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
	public static io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getMethodMethod() {
		io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getMethodMethod;
		if ((getMethodMethod = CommonServiceGrpc.getMethodMethod) == null) {
			synchronized (CommonServiceGrpc.class) {
				if ((getMethodMethod = CommonServiceGrpc.getMethodMethod) == null) {
					CommonServiceGrpc.getMethodMethod = getMethodMethod = io.grpc.MethodDescriptor.<com.again.boot.Request, com.again.boot.Response>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(generateFullMethodName("CommonService", "method"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(
									io.grpc.protobuf.ProtoUtils.marshaller(com.again.boot.Request.getDefaultInstance()))
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(com.again.boot.Response.getDefaultInstance()))
	...
	private static volatile io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getListFeaturesMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "ListFeatures",
			requestType = com.again.boot.Request.class, responseType = com.again.boot.Response.class,
			methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
	public static io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getListFeaturesMethod() {
		io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getListFeaturesMethod;
		if ((getListFeaturesMethod = CommonServiceGrpc.getListFeaturesMethod) == null) {
			synchronized (CommonServiceGrpc.class) {
				if ((getListFeaturesMethod = CommonServiceGrpc.getListFeaturesMethod) == null) {
					CommonServiceGrpc.getListFeaturesMethod = getListFeaturesMethod = io.grpc.MethodDescriptor.<com.again.boot.Request, com.again.boot.Response>newBuilder()
	...
	private static volatile io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getRecordRouteMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "RecordRoute",
			requestType = com.again.boot.Request.class, responseType = com.again.boot.Response.class,
			methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
	public static io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getRecordRouteMethod() {
		io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getRecordRouteMethod;
		if ((getRecordRouteMethod = CommonServiceGrpc.getRecordRouteMethod) == null) {
			synchronized (CommonServiceGrpc.class) {
				if ((getRecordRouteMethod = CommonServiceGrpc.getRecordRouteMethod) == null) {
					CommonServiceGrpc.getRecordRouteMethod = getRecordRouteMethod = io.grpc.MethodDescriptor.<com.again.boot.Request, com.again.boot.Response>newBuilder()
	...
	private static volatile io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getRouteChatMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "RouteChat",
			requestType = com.again.boot.Request.class, responseType = com.again.boot.Response.class,
			methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
	public static io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getRouteChatMethod() {
		io.grpc.MethodDescriptor<com.again.boot.Request, com.again.boot.Response> getRouteChatMethod;
		if ((getRouteChatMethod = CommonServiceGrpc.getRouteChatMethod) == null) {
			synchronized (CommonServiceGrpc.class) {
				if ((getRouteChatMethod = CommonServiceGrpc.getRouteChatMethod) == null) {
					CommonServiceGrpc.getRouteChatMethod = getRouteChatMethod = io.grpc.MethodDescriptor.<com.again.boot.Request, com.again.boot.Response>newBuilder()
	...
	public static abstract class CommonServiceImplBase implements io.grpc.BindableService {
		 ...
		 * </pre>
		 */
		public void method(com.again.boot.Request request,
				io.grpc.stub.StreamObserver<com.again.boot.Response> responseObserver) {
		 ...
		 * </pre>
		 */
		public void listFeatures(com.again.boot.Request request,
				io.grpc.stub.StreamObserver<com.again.boot.Response> responseObserver) {
		 ...
		 * </pre>
		 */
		public io.grpc.stub.StreamObserver<com.again.boot.Request> recordRoute(
				io.grpc.stub.StreamObserver<com.again.boot.Response> responseObserver) {
		 ...
		 * </pre>
		 */
		public io.grpc.stub.StreamObserver<com.again.boot.Request> routeChat(
				io.grpc.stub.StreamObserver<com.again.boot.Response> responseObserver) {
		...
		public final io.grpc.ServerServiceDefinition bindService() {
			return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
					.addMethod(getMethodMethod(),
							asyncUnaryCall(new MethodHandlers<com.again.boot.Request, com.again.boot.Response>(this,
									METHODID_METHOD)))
					.addMethod(getListFeaturesMethod(),
							asyncServerStreamingCall(
									new MethodHandlers<com.again.boot.Request, com.again.boot.Response>(this,
					...
					.addMethod(getRouteChatMethod(),
							asyncBidiStreamingCall(new MethodHandlers<com.again.boot.Request, com.again.boot.Response>(
	...
	public static final class CommonServiceBlockingStub extends io.grpc.stub.AbstractStub<CommonServiceBlockingStub> {
		 ...
		 * </pre>
		 */
		public com.again.boot.Response method(com.again.boot.Request request) {
		 ...
		 * </pre>
		 */
		public java.util.Iterator<com.again.boot.Response> listFeatures(com.again.boot.Request request) {
	...
	public static final class CommonServiceFutureStub extends io.grpc.stub.AbstractStub<CommonServiceFutureStub> {
		 ...
		 * </pre>
		 */
		public com.google.common.util.concurrent.ListenableFuture<com.again.boot.Response> method(
				com.again.boot.Request request) {
	...
	private static final class MethodHandlers<Req, Resp> implements io.grpc.stub.ServerCalls.UnaryMethod<Req, Resp>,
		...
		public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
			...
			case METHODID_METHOD:
				serviceImpl.method((com.again.boot.Request) request,
						(io.grpc.stub.StreamObserver<com.again.boot.Response>) responseObserver);
				break;
			case METHODID_LIST_FEATURES:
				serviceImpl.listFeatures((com.again.boot.Request) request,
						(io.grpc.stub.StreamObserver<com.again.boot.Response>) responseObserver);
				break;
			default:
		...
		public io.grpc.stub.StreamObserver<Req> invoke(io.grpc.stub.StreamObserver<Resp> responseObserver) {
			...
			case METHODID_RECORD_ROUTE:
				return (io.grpc.stub.StreamObserver<Req>) serviceImpl
						.recordRoute((io.grpc.stub.StreamObserver<com.again.boot.Response>) responseObserver);
			case METHODID_ROUTE_CHAT:
				return (io.grpc.stub.StreamObserver<Req>) serviceImpl
						.routeChat((io.grpc.stub.StreamObserver<com.again.boot.Response>) responseObserver);
			default:
				throw new AssertionError();
			}
		}
	...
	private static abstract class CommonServiceBaseDescriptorSupplier
		...
		public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
			return com.again.boot.GrpcService.getDescriptor();
		}
