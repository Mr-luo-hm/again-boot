package com.again.boot.starter.redis.core;

import com.again.boot.starter.redis.config.CachePropertiesHolder;
import com.again.boot.starter.redis.core.annotation.CacheDel;
import com.again.boot.starter.redis.core.annotation.CachePut;
import com.again.boot.starter.redis.core.annotation.Cached;
import com.again.boot.starter.redis.operation.CacheDelOps;
import com.again.boot.starter.redis.operation.CachePutOps;
import com.again.boot.starter.redis.operation.CachedOps;
...
public class CacheStringAspect {
	...
	@Pointcut("execution(@(@com.again.boot.starter.redis.core.annotation.MetaCacheAnnotation *) * *(..))")
