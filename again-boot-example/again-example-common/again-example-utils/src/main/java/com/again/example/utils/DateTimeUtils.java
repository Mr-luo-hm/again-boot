...
public class DateTimeUtils {
	...
	/**
	 * 判读给予的localDateTime是否再某个区间
	 * @param localDateTime 时间
	 * @param startTime 左区间
	 * @param endTime 右区间
	 * @return true/false
	 */
	public static boolean between(LocalDateTime localDateTime, String startTime, String endTime) {
		LocalDateTime startDate = DateTimeUtils.parseLocalDateTime(startTime);
		LocalDateTime endDate = DateTimeUtils.parseLocalDateTime(endTime);
		return localDateTime.isBefore(endDate) && localDateTime.isAfter(startDate);
	}
