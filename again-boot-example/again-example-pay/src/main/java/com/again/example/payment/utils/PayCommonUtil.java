...
public class PayCommonUtil {
	 ...
	 * @date 2016-4-22
	 * @Description：sign签名
	 * @param characterEncoding 编码格式 请求参数
	 * @return
	 */
	 ...
	 * @throws Exception
	 */
	public static String weixinPay(String orderPrice, String body, String outTradeNo) throws Exception {
		// 账号信息
		...
		/*
		 * String order_price = "1"; // 价格 注意：价格的单位是分 String body = "goodssssss"; // 商品名称
